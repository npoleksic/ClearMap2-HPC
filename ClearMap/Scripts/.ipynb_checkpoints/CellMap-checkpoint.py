...
if __name__ == "__main__":
  ...
  import sys
  sys.path.append('/home/npoleksic/ClearMap2')
  from ClearMap.Environment import *  #analysis:ignore
  
    
  #directories and files
  directory = '/home/npoleksic/LSS/ncb-core/users/npoleksic/sarah_data_new'    
  expression_raw      = 'cfos/16-09-36_TR1 640_UltraII_C00_xyz-Table Z<Z,4>.ome.tif'
  expression_auto     = 'autof/15-12-07_TR1 autofluo_UltraII_C00_xyz-Table Z<Z,4>.ome.tif'  
